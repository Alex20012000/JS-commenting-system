class DoComment {
    ...
    printComment() {
        ...
        for (let i = 1; i <= countComment; i++) { 
            ...
            //avatar.src = `https://picsum.photos/id/${i}/200/300`         // сайт picsum заблокирован, пробуем другой
            ...
            month = month + " " + hours + ":" + mins; // Снова были добавлены нули к временам датам, чтоб удобнее читалось  01  05  07
            ...
            c = localStorage.getItem("c" + i); // Получаем из хранилища комментарий (c1:коммент   c2:коммент   c3:коммент)
            commDiv.innerHTML = c;
